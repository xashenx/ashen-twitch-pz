...
-- function onPerkLevel(character, perk, level, levelUp)
AshenTwitchEvents.client.onPerkLevel = function(character, perk, level, levelUp)
    ...
    if character:getHoursSurvived() < 48 then return end
...
-- function newCharacter(playerIndex, player)
...
-- setBlockMovement
-- setForceSprint
Events.OnCreatePlayer.Add(AshenTwitchEvents.client.newCharacter)